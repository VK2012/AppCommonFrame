...
public class UiUtils {
    ...
    public static int dip2px(float dpValue) {
        final float scale = BaseApp.getInstance().getApplicationContext().getResources().getDisplayMetrics().density;
    ...
    public static Resources getResources() {
        return BaseApp.getInstance().getApplicationContext().getResources();
    }
